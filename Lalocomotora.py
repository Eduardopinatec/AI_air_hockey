...
class Player:
    ...
    def next_move(self, current_state):
        ...
        if (self.my_goal == 'right'):
            ...
            if (current_state['puck_pos']['x']>current_state['board_shape'][1]/3 or current_state['goals']['left']>
                    current_state['goals']['right'] or current_state['puck_speed']['y']>140):
                print ('Estoy defendiendo')
                self.my_paddle_pos = current_state['paddle1_pos'] if self.my_goal == 'left' \
                    else current_state['paddle2_pos']
