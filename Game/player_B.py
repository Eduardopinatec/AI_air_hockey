...
class Player:
    ...
    def next_move(self, current_state):
        ...
        """
        if current_state['goals']['right'] > current_state ['goals']['left']:# or current_state['puck_speed']['y']>150:
            ...
            if self.my_goal == 'left':
                ...
                if current_state['puck_pos']['x'] < current_state['paddle2_pos']['x']:
                    ...
                    self.bouncePoint = {'x': current_state['board_shape'][1], 'y': current_state['board_shape'][0] / 6}
            # find if puck path is inside my interest area
            ...
            if pt_in_roi:
                # estimate an aiming position
                if self.my_goal == 'left':
                    if current_state['puck_pos']['x'] < current_state['board_shape'][1] / 2 and \
                            current_state['puck_speed']['x'] < 200:
                        target_pos = utils.aim(pt_in_roi[0], pt_in_roi[1],
